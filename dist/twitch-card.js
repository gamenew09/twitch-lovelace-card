      ...
      >
        <div class="card-content">
          <div class="twitch-upper">
            ...
            <span id="twitch-display-name">${null!==(e=null!==(t=this.config.name)&&void 0!==t?t:l.attributes.friendly_name)&&void 0!==e?e:this.config.entity}</span>
            <span id="twitch-live-indicator" class="${d?"live":""}"></span>
            <mwc-button 
              @action=${this._handleAction}
              .actionHandler=${xt({hasHold:$t(this.config.hold_action),hasDoubleClick:$t(this.config.double_tap_action)})}
            >${Tt("common."+(d?"live_open_stream":"offline_open_stream"))}</mwc-button>
          </div>
          ${d?O`
          <hr>
          <div class="twitch-lower">
              <!-- Change thumbnail image, temp for now. -->
              <img class="twitch-stream-thumbnail" src="https://static-cdn.jtvnw.net/previews-ttv/live_user_${null!==(o=null===(i=l.attributes.friendly_name)||void 0===i?void 0:i.toLowerCase())&&void 0!==o?o:""}-440x248.jpg"></img>
              <div class="twitch-info">
                <div id="twitch-title">${c.title}</div>
                <div id="twitch-game" class="secondary">${null!==(n=c.game)&&void 0!==n?n:""}</div>
                <div id="twitch-viewers" class="secondary">${null!==(s=c.viewers)&&void 0!==s?s:"0"} viewers</div>
              </div>
          </div>
          `:""}
        </div>
