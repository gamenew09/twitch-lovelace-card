...
customElements.define('action-handler-twitch-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-twitch-card')) {
    return body.querySelector('action-handler-twitch-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-twitch-card');
